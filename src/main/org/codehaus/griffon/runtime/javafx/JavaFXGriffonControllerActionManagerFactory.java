 ...
 */
public class JavaFXGriffonControllerActionManagerFactory implements GriffonControllerActionManagerFactory {
    public GriffonControllerActionManager create(GriffonApplication app) {
        return new JavaFXGriffonControllerActionManager(app);
    }
}
